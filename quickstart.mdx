---
title: 'Quickstart'
description: 'Try again building beautiful documentation in under minutes'
---

## Setup your development

Learn how to update your docs focally and deploy them to the public.
...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    documentation changes locally with this command: ``` npm install -g mintlify ```
